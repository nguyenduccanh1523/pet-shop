        ...
        <>
            <section id="clothing" className="my-5 overflow-hidden">
                <div className="container pb-5">
                    ...
                    <div className="products-carousel swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div className="swiper-wrapper" id="swiper-wrapper-17427de1f7ef6005" aria-live="polite">
                            ...
                            <div className="swiper-slide swiper-slide-active" role="group" aria-label="1 / 6" style={{ width: "301.5px", marginRight: "30px" }}>
                                ...
                                <div className="card position-relative">
                                    <Link to="/single-product" style={{ textDecoration: 'none' }}><img src={item1} className="img-fluid rounded-4" alt="image" /></Link>
                            ...
                            <div className="swiper-slide swiper-slide-next" role="group" aria-label="2 / 6" style={{ width: "301.5px", marginRight: "30px" }}>
                                ...
                                <div className="card position-relative">
                                    <Link to="/single-product" style={{ textDecoration: 'none' }}><img src={item2} className="img-fluid rounded-4" alt="image" /></Link>
                                    <div className="card-body p-0">
                                        <Link to="/single-product" style={{ textDecoration: 'none' }}>
                                            <h3 className="card-title pt-4 m-0">Grey hoodie</h3>
                                        </Link>
