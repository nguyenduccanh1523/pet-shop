        ...
        <MDBRow className='g-0'>
          ...
          <MDBCol md='6' className='d-flex align-items-center justify-content-center'>
            <MDBCardBody className='w-100' style={{ maxWidth: 370, margin: 'auto' }}>
              ...
              <h5 className="fw-bold mb-4" style={{ letterSpacing: '1px', color: '#222' }}>Sign into your account</h5>
              ...
              <MDBBtn className="mb-3 w-100 py-2" color='dark' size='lg' style={{ borderRadius: 8, fontWeight: 600, fontSize: 18 }}>Login</MDBBtn>
              <div className="d-flex justify-content-between align-items-center mb-2">
                <a className="small text-muted" href="#" style={{ textDecoration: 'underline' }}>Forgot password?</a>
                <a className="small text-muted" href="#" style={{ textDecoration: 'underline' }}>Register here</a>
              </div>
